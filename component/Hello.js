...
class Hello extends Component {
  ...
  render() {
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Text style={{ backgroundColor: 'cyan' }}>and my sex is {this.props.sex}</Text>
        <Text style={{ backgroundColor: 'cyan' }}>and my salary is {this.state.salary} $  </Text> 
  ...
  onPressNextYear() {
    ...
    var curMoney = this.state.salary;
    this.setState({
      age: curAge + 1,
      weight: curWeight + 2,
      salary: curMoney + 3000,
    });
  }
}
